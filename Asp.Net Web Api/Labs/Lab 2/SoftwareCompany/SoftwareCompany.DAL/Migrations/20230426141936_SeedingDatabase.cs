    ...
    public partial class SeedingDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, "Karim Ali", 24000m },
                    { 2, "Rana Youssef", 30000m },
                    { 3, "Mohamed Moustafa", 21000m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, "Fix Code Issues", "Bug Fixing" },
                    { 2, 1, "Add Animations on Landing Page", "Landing Page" },
                    { 3, 3, "Update Connection String to DB Server", "DB Server" }
                });
