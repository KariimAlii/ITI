...
void PrintMenu(int x)
{
	...
	printf("2.Search for a Student By his ID");
	gotoxy(x,ySearchByName);
	printf("3.Search for a Student By his Name");
	gotoxy(x,yDeleteById);
	printf("4.Delete a Student By his ID");
	gotoxy(x,yFreeList);
    printf("5.Delete All Students");
	gotoxy(x,yInsertByLoc);
	printf("6.Insert a new Student by His Location");
	gotoxy(x,yUpdateById);
	printf("7.Update a Student info by his ID");
