...
void PrintMenu(int x)
{
    ...
    gotoxy(x,yAddNode);
	cprintf("1.Add a New Node to The Tree");
	gotoxy(x,yInOrder);
	cprintf("2.Print The Tree Nodes in order");
	gotoxy(x,yPreOrder);
	cprintf("3.Print The Tree Nodes pre order");
	gotoxy(x,yPostOrder);
	cprintf("4.Print The Tree Nodes post order");
	gotoxy(x,yExit);
	cprintf("5.Exit");
}
